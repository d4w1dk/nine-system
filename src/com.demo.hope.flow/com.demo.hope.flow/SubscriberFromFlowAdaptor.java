...
import static com.demo.hope.flow.SubscriptionAdaptor.toFlowSubscription;
...
public class SubscriberFromFlowAdaptor<T> implements org.reactivestreams.Subscriber<T> {
    ...
    private SubscriberFromFlowAdaptor(Flow.Subscriber<T> delegate) {this.delegate = delegate;}
